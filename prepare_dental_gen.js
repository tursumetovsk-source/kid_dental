...
<style>
  ...
  .dg-parent-questions-section {
    ...
    padding: clamp(40px, 6vw, 75px) 16px clamp(48px, 7vw, 90px) !important;
    box-sizing: border-box !important;
    z-index: 5 !important;
    overflow: hidden !important;
  }
  ...
  .dg-pq-speech-bubble--purple {
    border: 2.5px solid #8e62d4;
    border-bottom-left-radius: 6px;
    align-self: flex-start;
    width: min(580px, 100%);
    box-shadow: 0 4px 14px rgba(142, 98, 212, 0.08);
  }
  .dg-pq-speech-bubble--teal {
    border: 2.5px solid #00b4a7;
    border-bottom-left-radius: 6px;
    align-self: flex-end;
    width: min(540px, 100%);
    box-shadow: 0 4px 14px rgba(0, 180, 167, 0.08);
  }
  .dg-pq-speech-bubble--pink {
    border: 2.5px solid #f04d6f;
    border-bottom-left-radius: 6px;
    align-self: flex-start;
    width: min(580px, 100%);
    box-shadow: 0 4px 14px rgba(240, 77, 111, 0.08);
  }
