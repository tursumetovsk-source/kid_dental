...
<style>
  ...
  @media (max-width: 809px) {
    [data-framer-name="Hero"] {
      min-height: 100vh !important;
      min-height: 100dvh !important;
      padding: clamp(65px, 8vh, 85px) 16px clamp(40px, 6vh, 60px) !important;
      display: flex !important;
      flex-direction: column !important;
      justify-content: center !important;
      align-items: center !important;
    ...
    .dg-doodle-star-tl { top: 2px; left: 1%; width: 28px; height: 28px; }
    .dg-doodle-star-tc { top: -8px; left: 50%; width: 22px; height: 22px; }
    .dg-doodle-star-tr { top: 2px; right: 2%; width: 26px; height: 26px; }
    .dg-doodle-heart-tr { top: 18px; right: 1%; width: 26px; height: 24px; }
    .dg-doodle-planet { top: 30%; left: -6px; width: 44px; height: 34px; }
    .dg-doodle-rocket { top: 32%; right: -2px; width: 42px; height: 42px; }
    .dg-doodle-star-mr { display: none; }
    .dg-doodle-trail { display: none; }
  }
  ...
  @media (max-width: 809px) {
    ...
    .dg-programs { padding: 40px 14px 50px; }
    .dg-programs h2 { font-size: clamp(30px, 8vw, 48px); }
    .dg-grid { grid-template-columns: 1fr; margin-top: 20px; }
    .dg-checkup {
    ...
    .dg-contact { padding: 36px 14px 44px; }
    .dg-contact__inner { grid-template-columns: 1fr; align-items: start; gap: 20px; }
    .dg-contact h2 { font-size: clamp(30px, 8vw, 46px); }
    [data-framer-name="Intro"].dg-parent-story-section { padding: 40px 12px 80px !important; }
    .dg-story-questions { gap: 14px; }
    .dg-story-question,
    .dg-story-question:nth-child(1),
    .dg-story-question:nth-child(2),
    .dg-story-question:nth-child(3) { width: 100%; margin-left: 0; padding: 16px 14px; border-radius: 20px; transform: none; }
    .dg-story-question { grid-template-columns: 28px minmax(0, 1fr); gap: 8px; min-height: 0; }
    .dg-story-question__mark { font-size: 36px; }
    .dg-story-question p { font-size: clamp(15px, 4.5vw, 18px); line-height: 1.25; }
    .dg-story-copy { width: 100%; margin-top: 32px; }
    .dg-story-copy p { font-size: 16px; line-height: 1.5; }
    .dg-story-copy p + p { margin-top: 16px; }
    .dg-story-actions { flex-direction: column; gap: 10px; margin-top: 24px; }
    .dg-story-actions a, .dg-story-actions button { min-width: 0; padding: 14px 18px; border-radius: 20px; font-size: 15.5px; }
    .dg-story-spark--left { left: 2px; }
    .dg-story-spark--right { right: 0; top: -38px; }
    .dg-story-spark--bottom { display: none; }
    .dg-programs-carousel { padding: 6px 10px 24px; }
    .dg-carousel-cards-wrapper { min-height: 560px; width: 100%; }
    .dg-pcard { padding: 16px 14px 18px; border-radius: 22px; box-shadow: -4px 5px 0 #2f2076; }
    .dg-pcard__inner { grid-template-columns: 1fr; gap: 10px; }
    .dg-pcard__media { padding: 0; }
    .dg-pcard__img { max-width: 95px; }
    .dg-pcard__title { font-size: 22px; margin-bottom: 6px; }
    .dg-pcard__lead { font-size: 13px; margin-bottom: 10px; line-height: 1.35; }
    .dg-pcard__list { margin-bottom: 12px; gap: 6px; }
    .dg-pcard__list li { font-size: 12.5px; }
    .dg-pcard__cta { width: 100%; text-align: center; font-size: 15px; padding: 12px 16px; min-height: 46px; }
    ...
    .dg-carousel-arrow--prev { left: -6px; }
    .dg-carousel-arrow--next { right: -6px; }
    ...
    .dg-game-teaser__left h3 { font-size: clamp(20px, 5.5vw, 26px) !important; margin: 0 0 8px !important; }
    .dg-game-teaser__left p { font-size: 13.5px !important; line-height: 1.4 !important; margin: 0 0 12px !important; }
    .dg-game-teaser__buttons { flex-direction: column !important; width: 100% !important; gap: 8px !important; }
    .dg-game-teaser__btn { width: 100% !important; font-size: 15px !important; padding: 12px 16px !important; min-height: 46px !important; }
    .dg-game-modal {
      padding: 0 !important;
      width: 100vw !important;
      height: 100vh !important;
...
<script>
  (() => {
    ...
    window.setProgramSlide = (index) => {
      const carousels = document.querySelectorAll(".dg-programs-carousel");
      const normalized = ((index % 3) + 3) % 3;
      carousels.forEach((carousel) => {
        const cards = carousel.querySelectorAll(".dg-pcard");
        const dots = carousel.querySelectorAll(".dg-carousel-dot");
    ...
    if (!window.__dgEventsBound) {
      ...
      document.addEventListener("click", (e) => {
        ...
        // Prev slide button
        if (e.target.closest(".dg-carousel-arrow--prev") || e.target.closest(".framer-bayurr-container a")) {
          e.preventDefault();
          e.stopPropagation();
          window.prevProgramSlide();
          return;
        ...
        // Next button
        if (e.target.closest(".dg-carousel-arrow--next") || e.target.closest(".framer-1kxwop3-container a")) {
          e.preventDefault();
          e.stopPropagation();
          window.nextProgramSlide();
          return;
    ...
    const getHeroCanvasHTML = () => {
      return '<div class="dg-hero-doodles" aria-hidden="true">' +
    ...
    const buildCustomHeroSection = () => {
      const heroContainers = document.querySelectorAll('[data-framer-name="Hero"]');
      heroContainers.forEach((heroContainer) => {
        if (!heroContainer.querySelector(".dg-hero-custom-canvas")) {
          const canvas = document.createElement("div");
          canvas.className = "dg-hero-custom-canvas";
          canvas.innerHTML = getHeroCanvasHTML();
          heroContainer.appendChild(canvas);
        }
      });
    };

    const getParentQuestionsHTML = () => {
      return '<div class="dg-pq-container">' +
        '<!-- Surrounding Doodles -->' +
    ...
    const insertParentQuestionsSection = () => {
      const heroes = document.querySelectorAll('[data-framer-name="Hero"]');
      heroes.forEach((hero) => {
        const parent = hero.parentNode;
        if (!parent) return;
        if (!parent.querySelector('.dg-parent-questions-section')) {
          const section = document.createElement("section");
          section.className = "dg-parent-questions-section";
          section.innerHTML = getParentQuestionsHTML();
          if (hero.nextSibling) {
    ...
    const getProgramsCarouselHTML = () => {
      return '<div class="dg-carousel-headline"><h3>С DENTAL GEN ВЫ МОЖЕТЕ:</h3><p>ПОМОГАЮТ ВОВРЕМЯ ЗАБОТИТЬСЯ О ЗУБАХ И ПРИКУСЕ РЕБЁНКА</p></div>' +
        '<div class="dg-programs-carousel">' +
          '<div class="dg-carousel-cards-wrapper">' +
            '<!-- Card 1: 1-3 года -->' +
          ...
          '</div>' +
          '<!-- Arrow Controls -->' +
          '<button class="dg-carousel-arrow dg-carousel-arrow--prev" type="button" aria-label="Предыдущая программа" title="Назад">' +
          ...
          '</button>' +
          '<button class="dg-carousel-arrow dg-carousel-arrow--next" type="button" aria-label="Следующая программа" title="Вперед">' +
    ...
    const enhanceProgramsCarousel = () => {
      const missions = document.querySelectorAll('[data-framer-name="Mission"], #mission, #mission-block');
      missions.forEach((mission) => {
        const parent = mission.parentNode;
        if (!parent) return;
        if (!parent.querySelector('.dg-programs-carousel-section')) {
          const section = document.createElement("section");
          section.className = "dg-programs-carousel-section";
          section.innerHTML = getProgramsCarouselHTML();
          if (mission.nextSibling) {
            parent.insertBefore(section, mission.nextSibling);
          } else {
            parent.appendChild(section);
          }
        }
      ...
      return '<div class="dg-shell">' +
        '<div class="dg-game-teaser__card">' +
          '<div class="dg-game-teaser__left">' +
            ...
            '</div>' +
          '</div>' +
          '<div class="dg-game-teaser__right dg-open-game-btn" data-game-mode="hub" title="Нажмите, чтобы сыграть!">' +
    ...
    const getContactHTML = () => {
      return '<div class="dg-contact__inner">' +
        '<div><h2>DENTAL GEN</h2><p>Детская стоматология</p><p>г. Иваново, ул. Профсоюзная, 4</p></div>' +
        '<div class="dg-contact__actions"><a href="tel:+79109900060">+7 (910) 990-00-60</a><a href="https://dentalgen.pro">dentalgen.pro</a></div>' +
      '</div>';
    };
    ...
    const addLandingSections = () => {
      ...
      heroes.forEach((hero) => {
        ...
        // Checkup
        if (!parent.querySelector(".dg-checkup-section")) {
          const section = document.createElement("section");
          section.className = "dg-checkup-section";
          section.innerHTML = getCheckupHTML();
          const programs = parent.querySelector(".dg-programs-carousel-section");
          if (programs && programs.nextSibling) {
            parent.insertBefore(section, programs.nextSibling);
          } else {
            parent.appendChild(section);
          }
        }
        ...
        // Contacts
        if (!parent.querySelector(".dg-contact")) {
          const section = document.createElement("section");
          section.className = "dg-contact";
          section.setAttribute("aria-label", "Контакты DENTAL GEN");
          section.innerHTML = getContactHTML();
          const gameTeaser = parent.querySelector(".dg-game-teaser");
          const ref = gameTeaser || parent.querySelector(".dg-checkup-section") || parent.querySelector(".dg-programs-carousel-section");
          if (ref && ref.nextSibling) {
            parent.insertBefore(section, ref.nextSibling);
          } else {
            parent.appendChild(section);
          }
        }
    ...
    const getGameModalHTML = () => {
      return '<div class="dg-game-modal__backdrop" id="gameModalBackdrop"></div>' +
        '<div class="dg-game-modal__container">' +
          '<div class="game-wrapper">' +
            '<header class="game-header">' +
              '<div class="game-header-brand">' +
                '<div class="game-mascot-avatar">🦷</div>' +
                '<div>' +
                  '<h2 class="game-title">DENTAL GEN KIDS CLUB</h2>' +
                  '<p class="game-subtitle" id="dgGameHeaderSubtitle">Интерактивный центр здоровья зубок</p>' +
                '</div>' +
              '</div>' +
              '<div class="game-controls">' +
                '<button class="game-sound-btn" id="dgSoundToggle" type="button" aria-label="Звуковые эффекты">🔊</button>' +
                '<button class="game-hub-btn" id="dgBackToHubBtn" type="button" style="display: none;">🎮 <span>КАТАЛОГ</span></button>' +
                '<button class="game-close-btn" id="closeGameModalBtn" type="button" aria-label="Закрыть игру">✕ <span>Выйти</span></button>' +
              '</div>' +
            '</header>' +
            '<!-- VIEW 1: GAME HUB (CATALOG OF 8 GAMES) -->' +
            '<div class="game-hub-view" id="dgGameHubView">' +
              '<div class="hub-hero-banner">' +
                '<span class="hub-hero-badge" id="dgGameBadge">🎮 8 ИНТЕРАКТИВНЫХ ИГР</span>' +
                '<h3 class="hub-hero-title">Выбирай игру и отправляйся в приключение!</h3>' +
                '<p class="hub-hero-sub">Все игры разработаны детскими стоматологами DENTAL GEN для веселого обучения и адаптации к заботе о зубках.</p>' +
                '<div class="hub-filters-row">' +
                  '<button class="hub-filter-btn is-active" data-filter="all" type="button">Все игры (8)</button>' +
                  '<button class="hub-filter-btn" data-filter="toddler" type="button">1–3 года (Малыши)</button>' +
                  '<button class="hub-filter-btn" data-filter="preschool" type="button">3–5 лет (Дошколята)</button>' +
                  '<button class="hub-filter-btn" data-filter="older" type="button">5–7 лет (Подготовка к школе)</button>' +
                '</div>' +
              '</div>' +
              '<div class="hub-grid" id="dgHubGrid"></div>' +
            '</div>' +
            '<!-- VIEW 2: ACTIVE GAME PLAYER -->' +
            '<div class="game-active-view" id="dgGameActiveView" style="display: none;">' +
              '<div class="game-hint-banner" id="dgGameHintBanner">' +
                '<span class="hint-icon">💡</span>' +
                '<span id="dgHintText">Нажми на щётку и помоги зубику стать чистым!</span>' +
              '</div>' +
              '<div class="game-stage" id="dgGameStage">' +
                '<div class="game-scene" id="dgDynamicGameStage">' +
                  '<!-- Dynamic Interactive Content Rendered via JS -->' +
                '</div>' +
                '<div class="game-items-layer" id="dgGameItemsLayer"></div>' +
              '</div>' +
    ...
    const addKidsGame = () => {
      ...
      heroes.forEach((hero) => {
        const parent = hero.parentNode;
        if (!parent) return;
        if (!parent.querySelector(".dg-game-teaser")) {
          ...
          teaser.innerHTML = getGameTeaserHTML();
          const checkup = parent.querySelector(".dg-checkup-section");
          const ref = checkup || parent.querySelector(".dg-programs-carousel-section");
          if (ref && ref.nextSibling) {
            parent.insertBefore(teaser, ref.nextSibling);
          } else {
      ...
      // Modal is singleton on document.body
      if (!document.getElementById("gameModal")) {
        ...
        modal.innerHTML = getGameModalHTML();
    ...
    const apply = () => {
      ...
      for (const el of document.querySelectorAll('h1, h2, h3, h4, span, p, a, button, [data-framer-name="App Store"], [data-framer-name="Button Shape"]')) {
        if (el.closest && (el.closest('.dg-hero-custom-canvas') || el.closest('[data-framer-name="Hero"]'))) continue;
      ...
      const cursiveTitle = document.querySelector('.dg-hero-cursive-title');
      if (cursiveTitle) {
        const l1 = cursiveTitle.querySelector('.dg-hct-line-1');
        const l2 = cursiveTitle.querySelector('.dg-hct-line-2');
        const l3 = cursiveTitle.querySelector('.dg-hct-line-3');
        const l4 = cursiveTitle.querySelector('.dg-hct-line-4');
        if (l1) l1.textContent = "Здоровая улыбка";
        if (l2) l2.textContent = "сегодня — уверенность";
        if (l3) l3.textContent = "и счастье";
        if (l4) l4.textContent = "на всю жизнь!";
      }
