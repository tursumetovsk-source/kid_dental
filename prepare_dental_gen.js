...
<style>
  ...
  .dg-story-actions { display: flex; justify-content: center; gap: 20px; margin-top: 56px; flex-wrap: wrap; }
  .dg-story-actions a, .dg-story-actions button {
    ...
    font: 800 21px/1 "BN Dime Display Regular", "Rubik", sans-serif;
    text-align: center;
  ...
  .dg-story-game-btn { border-color: #2f2076 !important; background: #ffe59a !important; color: #2f2076 !important; }
  .dg-story-actions a:hover, .dg-story-actions button:hover { transform: translateY(-2px); box-shadow: 0 20px 32px rgba(89, 54, 151, .2); }
