...
<style>
  ...
  .dg-parent-questions-section {
    ...
    justify-content: center !important;
    background: #ffe9ed !important;
    padding: clamp(36px, 5vw, 64px) 16px clamp(40px, 6vw, 70px) !important;
    box-sizing: border-box !important;
    z-index: 5 !important;
  }
...
<script>
  (() => {
    ...
    const insertParentQuestionsSection = () => {
      ...
      section.innerHTML = '<div class="dg-parent-questions-card">' +
        '<span class="dg-pq-sparkle dg-pq-sparkle--1">⭐</span><span class="dg-pq-sparkle dg-pq-sparkle--2">🪐</span>' +
